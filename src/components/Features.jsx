      ...
      <div className='container mx-auto px-3 md:px-10'>
        <div className="px-5 py-32">
            ...
            <p className='max-w-md font-circular-web text-lg text-blue-50 text-opacity-50'>
                Immerse yourself in a rich and ever-expanding universe where a vibrant aray of products converge into an interconnected overlay experience on your word.
            </p>
        </div>
